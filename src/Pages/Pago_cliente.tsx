...
import { apiCrearInscripcion, apiObtenerInscripcion, apiObtenerMembresias } from '../API/api_membresias';
...
const Pago_cliente = ({ cambio, cliente, id_cliente }: PagoProp) => {
    ...
    const enviarForm = () => {
       if(confirm("Desea registrar el cobro?")){
        ...
        const generarMembresiaCliente: MembresiaCliente = {
            id_cliente: Number(datos.id_cliente),
